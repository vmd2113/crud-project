...
<link rel="stylesheet"
      href=<c:url value='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css'/>
...
<!-- main css -->
<link href="<c:url value='/template/admin-homepage/css/admin-homepage.css' />" rel="stylesheet" />
</head>
...
<script src="<c:url value='/template/admin-homepage/js/admin-homepage.js'/>"></script>
