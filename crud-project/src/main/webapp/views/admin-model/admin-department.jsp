...
<section class="container">
  <div class=" row admin-content">
    ...
    <div class="admin-information col-9">
      ...
      <form id="formSubmit" class="" action="<c:url value='/admin-department'/>" method="GET">
        <div class="container">
          ...
          <div class="admin-information__tool d-flex justify-content-between my-3">
            ...
            <table class="table">
              ...
              <tbody>
                <c:forEach var="item" items="${DepartmentModel.getListModel()}">
                <tr>
                  <td>${item.getId()}</td>
...
<script type="text/javascript">
  var currentPage_ = ${DepartmentModel.getPage()};
  var totalPages_ = ${DepartmentModel.getTotalPages()};
  var limit = 5;
